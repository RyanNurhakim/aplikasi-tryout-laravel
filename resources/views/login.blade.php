        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-lg">
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 class="my-2 text-center text-2xl font-bold text-gray-900">Login</h2>
                </div>
                ...
                <form class="space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" autocomplete="email" required
                            class="mt-2 block w-full rounded-lg border border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2.5"
                ...
                <p class="mt-6 text-center text-sm text-gray-600">
                    Belum punya akun?
                    <a href="{{ route('registrasi.show') }}" class="font-semibold text-indigo-600 hover:text-indigo-500">Daftar</a>
                </p>
            </div>
        </div>
    </div>
